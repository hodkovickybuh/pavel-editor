...
```html
<script src="https://cdn.jsdelivr.net/gh/hodkovickybuh/pavel-editor@v1.9.2/dist/pavel-editor.js"></script>
```
...
```js
var s=document.createElement('script');s.src='https://cdn.jsdelivr.net/gh/hodkovickybuh/pavel-editor@v1.9.2/dist/pavel-editor.js';document.body.appendChild(s);
```
